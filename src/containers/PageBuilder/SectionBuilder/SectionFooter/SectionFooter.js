...
const SectionFooter = props => {
  ...
  var currentLocation = typeof window!="undefined" && window.location;
  const isAuthPage = currentLocation && currentLocation.pathname && (currentLocation.pathname.includes("/login") || currentLocation.pathname.includes("/signup") || currentLocation.pathname.includes("/adminLogin"));
            ...
            <div className={css.footerLogo}>
              ...
              <div>
                <svg width="130" height="24" viewBox="0 0 130 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M106.978 8.006H102.983L102.716 8H99.286L96 15.68H99.911L100.406 14.49H101.536L102.03 15.68H118.94L120.065 14.49L121.143 15.68H125.977L122.494 11.852L126.013 8H121.25L120.135 9.19L119.057 8H108.687L107.865 9.941L106.978 8.006ZM117.046 10.346H114.069V11.173H116.998V12.412H114.075V13.334H117.052V14.073L119.129 11.828L117.052 9.488L117.046 10.346ZM100.971 10.268L101.745 12.144H100.203L100.971 10.268ZM111.646 9.084H109.407L107.907 12.62L106.282 9.084H104.06V13.894L102 9.084H100.007L97.625 14.596H99.18L99.674 13.406H102.27L102.764 14.596H105.484V10.661L107.235 14.602H108.425L110.165 10.673V14.603H111.623L111.647 9.083L111.646 9.084ZM123.517 9.084L120.986 11.852H120.987L123.499 14.602H121.624L120.076 12.864L118.462 14.602H112.652V9.084H118.546L120.094 10.81L121.695 9.084H123.517Z" fill="white" />
                </svg>
