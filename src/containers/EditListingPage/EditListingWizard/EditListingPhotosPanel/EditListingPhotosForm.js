            ...
            <AspectRatioWrapper width={aspectWidth} height={aspectHeight}>
              ...
              <label htmlFor={name} className={css.addImage}>
                  ...
                  <svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M35.8334 0H17.2V12.9C17.2 15.561 16.143 18.113 14.2613 19.9946C12.3797 21.8763 9.8277 22.9333 7.1667 22.9333H2.8667V38.7C2.8667 39.8404 3.31973 40.9342 4.12614 41.7406C4.93255 42.547 6.02627 43 7.1667 43H35.8334C36.9738 43 38.0675 42.547 38.8739 41.7406C39.6803 40.9342 40.1334 39.8404 40.1334 38.7V4.3C40.1334 3.15957 39.6803 2.06585 38.8739 1.25944C38.0675 0.453034 36.9738 0 35.8334 0ZM31.5334 11.4667H20.0667V14.3333H31.5334V11.4667ZM31.5334 20.0667H20.0667V22.9333H31.5334V20.0667ZM11.4667 28.6667H31.5334V31.5333H11.4667V28.6667Z" fill="#FC0483" />
                  </svg>
