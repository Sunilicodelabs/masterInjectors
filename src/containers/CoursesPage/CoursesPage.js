...
import NoSearchResultsMaybe from '../SearchPage/NoSearchResultsMaybe/NoSearchResultsMaybe';
...
import SearchFiltersMobile from '../SearchPage/SearchFiltersMobile/SearchFiltersMobile';
import MainPanelHeader from '../SearchPage/MainPanelHeader/MainPanelHeader';
...
export class CoursesPageComponent extends Component {
  constructor(props) {
    super(props);
  ...
  resetAll(e) {
    ...
    history.push(createResourceLocatorString('CoursesPage', routeConfiguration, {}, queryParams));
  }
    ...
    return updatedURLParams => {
      ...
      const callback = () => {
        if (useHistoryPush) {
          ...
          history.push(createResourceLocatorString('CoursesPage', routeConfiguration, {}, search));
        }
      };
          ...
          <div className={css.layoutWrapperMain} role="main">
            <div className={css.searchResultContainer}>
              ...
              >
                ...
                {!isValidDatesFilter ? (
                  <H5>
                    <FormattedMessage id="CoursesPage.invalidDatesFilter" />
                  </H5>
                ) : null}
                <SearchResultsPanel
...
CoursesPageComponent.defaultProps = {
  listings: [],
  pagination: null,
...
const EnhancedCoursesPage = props => {
