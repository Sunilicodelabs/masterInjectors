...
export class TemplatePageComponent extends Component {
  constructor(props) {
    super(props);
  ...
  resetAll(e) {
    ...
    history.push(createResourceLocatorString('TemplatePage', routeConfiguration, {}, queryParams));
  }
    ...
    return updatedURLParams => {
      ...
      const callback = () => {
        if (useHistoryPush) {
          ...
          history.push(createResourceLocatorString('TemplatePage', routeConfiguration, {}, search));
        }
      };
...
const EnhancedTemplatePage = props => {
